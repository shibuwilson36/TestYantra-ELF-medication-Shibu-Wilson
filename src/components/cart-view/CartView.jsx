...
function CartView(props) {
    ...
    let incrementItem = (value) => {
        ...
        if(getCount.count <10){
            if (value === 0) {
                props.changePrice(props.text, getCount.count + 1,true)
        ...
        if (getCount.count > 1) {
            ...
            if (value === 1) {
                props.changePrice(props.text, getCount.count - 1,false)
       ...
       <div className="card ">
            <div className="  "  >
                ...
                <div className="col-md-6 float-left card-body ">
                    <div className="">
                        <img className="col-md-4 h-50 float-left  " src={props.text.pImage} alt=""></img>
                        <Paper elevation={3} />
                        <p className="col-md-6 float-left " >
                            <h5>{props.text.pName}</h5>
                            <p>{props.text.company}</p>
                ...
                <div className="col-md-4 float-left  card-body">
                    ...
                    <p>Delivery by {date.getDate()+1} {month}  | Free₹40</p>
